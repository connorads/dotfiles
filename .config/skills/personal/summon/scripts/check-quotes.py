...
See ``references/attribution.md`` for the grammar itself. The parsing half lives
in ``scripts/quotelib.py``, shared with ``scripts/verify-pointers.py``; what is
left here is the judging half - which attribution shapes are acceptable.

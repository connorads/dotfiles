...
```bash
<!-- LOCAL PATCH (connorads dotfiles): upstream config reference executes a mutable npm package; use the audited pinned CLI through pnpm. -->
pnpm dlx @coldtea/pr-lens-cli@0.4.0 validate .github/pr-lens.yml
```

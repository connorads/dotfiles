...
<!-- LOCAL PATCH (connorads dotfiles): vgpu CLI is mise-pinned; npx bypasses the pin and is a network call per doc lookup -->
...
258 symbols across 20 packages — open `references/<package>/<file>` or `vgpu docs cat <symbol>`:

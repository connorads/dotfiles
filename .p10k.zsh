# Generated by Powerlevel10k configuration wizard on 2026-01-25 at 23:57 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    context                   # user@host
    nix_shell                 # nix shell/develop indicator
    dir                       # current directory
    vcs                       # git status
    command_execution_time    # previous command duration
    background_jobs           # backgrounded/suspended job count
    # =========================[ Line #2 ]=========================
    newline                   # \n
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    python                    # python version (pyenv/venv)
    time                      # current time
    # =========================[ Line #2 ]=========================
    newline                   # \n
  )
  ...
  # Show one decimal place. Thus, 7.3s rather than 7s.

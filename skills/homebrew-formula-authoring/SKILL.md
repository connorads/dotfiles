...
- Prefer the official Homebrew docs (Formula Cookbook, Acceptable Formulae, Package-Acceptance-Policy - the latter holds the notability, fork, and acceptance rules) when uncertain. Don't author from memory - the DSL and policy change.
